# Generated by Django 5.2.6 on 2025-09-19 04:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('paper', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='summary', to='app.researchpaper')),
            ],
        ),
        migrations.CreateModel(
            name='PaperEmbedding',
            fields=[
                ...
                ('model_used', models.CharField(default='gemini-2.5-pro', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='embeddings', to='app.researchpaper')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('papers', models.ManyToManyField(related_name='comparisons', to='app.researchpaper')),
            ],
        ),
        migrations.CreateModel(
            name='SearchQuery',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slides', to='app.researchpaper')),
            ],
        ),
        migrations.CreateModel(
